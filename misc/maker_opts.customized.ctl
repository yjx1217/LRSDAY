...
genome=$genome_assembly  #genome sequence (fasta file or fasta embeded in GFF3 file)
...
est=$LRSDAY_HOME/data/SGDref.PoFF.ffn #set of ESTs or assembled mRNA-seq in fasta format
altest= #EST/cDNA sequence file in fasta format from an alternate organism
est_gff= #aligned ESTs or mRNA-seq from an external GFF3 file
altest_gff= #aligned ESTs from a closly relate species in GFF3 format

#-----Protein Homology Evidence (for best results provide a file for at least one)
protein=$LRSDAY_HOME/data/Proteome_DB_for_annotation.CDhit_I95.fa  #protein sequence file in fasta format (i.e. from mutiple oransisms)
...
#-----Gene Prediction
snaphmm=$LRSDAY_HOME/data/S288C.gene.hmm #SNAP HMM file
...
snoscan_rrna=$LRSDAY_HOME/data/Sc-rRNA.fa #rRNA file to have Snoscan find snoRNAs
snoscan_meth=$LRSDAY_HOME/data/Sc-meth.sites #-O-methylation site file to have Snoscan find snoRNAs
...
single_length=90 #min length required for single exon ESTs if 'single_exon is enabled'
